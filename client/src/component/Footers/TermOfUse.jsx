    ...
    <div className='container termofuse-container'>
      ...
      <div className="container">
        ...
        <div className="para fs-4">
          ...
          <li className='mb-3'>Disclaimer of Warranties: The Website is provided on an &quot;as is&quot; and &quot;as available&quot; basis, without any warranties of any kind, express or implied. Bitbox does not warrant that the Website will be error-free or uninterrupted, or that any defects will be corrected. Bitbox disclaims all warranties, including but not limited to warranties of merchantability, fitness for a particular purpose, and non-infringement.</li>
          <li className='mb-3'>Limitation of Liability: Bitbox shall not be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising out of or in any way connected with your use of the Website or any content on the Website. This includes, but is not limited to, damages for loss of profits, goodwill, use, data, or other intangible losses, even if Bitbox has been advised of the possibility of such damages.</li>
          <li className='mb-3'>Indemnification: You agree to indemnify and hold harmless Bitbox, its affiliates, partners, officers, directors, employees, agents, and licensors from any claims, liabilities, damages, losses, or expenses (including legal fees) arising out of or in any way related to your use of the Website or violation of these Terms of Use.</li>
          <li className='mb-3'>Governing Law and Jurisdiction: These Terms of Use shall be governed by and construed in accordance with the laws of [Your Jurisdiction], without regard to its conflict of law provisions. Any dispute arising out of or in connection with these terms shall be subject to the exclusive jurisdiction of the courts of [Your Jurisdiction].</li>
          <li className='mb-3'>Changes to Terms: Bitbox reserves the right to modify or update these Terms of Use at any time without prior notice. By continuing to use the Website after any changes are made, you agree to be bound by the revised terms.</li>
        </div>
      </div>
    </div>
  )
