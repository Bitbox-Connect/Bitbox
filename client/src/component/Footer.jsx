...
const Footer = (props) => {
  ...
  return (
    <>
      ...
      <div
        className="Footer"
        style={{ backgroundColor: props.mode === "dark" ? "#0B192C" : "white" }}
      >
        <div className="container">
          ...
          <div className="row">
            ...
            <div
              className="col-md-6 col-lg-5 col-12 ft-1"
              data-aos="fade-up"
              data-aos-delay="100"
            ...
            >
              <h3 style={{ fontFamily: "medium", fontSize: "2.5rem" }}>
                BIT
                <span className="code" style={{ color: "#0D92F4" }}>
                  BOX
                </span>
              </h3>
              <p>
              ...
              <div className="footer-icons">
                ...
                <a
                  href="https://github.com/bitboxcommunity"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="GitHub"
                >
                ...
                <a
                  href="https://twitter.com/BITBOX688152"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Twitter"
                >
                ...
                <a
                  href="https://www.youtube.com/channel/UCXUTdcw27jaH_go9iyUjJnA"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="YouTube"
                >
                ...
                <a
                  href="https://www.linkedin.com/in/bit-box-community"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="LinkedIn"
                >
            ...
            <div
              className="col-md-6 col-lg-3 col-12 ft-2 "
              data-aos="fade-up"
              data-aos-delay="300"
              data-aos-duration="1800"
            >
            ...
            <div
              className="col-md-7 col-lg-4 col-13 ft-3"
              data-aos="fade-up"
              data-aos-delay="500"
              data-aos-duration="1800"
            >
