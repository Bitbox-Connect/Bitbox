...
function Navbar(props) {
    ...
    const { title, home, community, discussion, about, mode, toggleMode, showAlert } = props;
    ...
    return (
        <div>
            <nav className={`navbar navbar-expand-lg ${isScrolled ? 'sticky' : ''} navbar-${mode}`} style={{ backgroundColor: mode === 'dark' ? 'black' : 'white', borderBottom: mode === 'dark' ? '1px solid white' : '1px solid black' }} id='navbar'>
                    ...
                    <div className="collapse navbar-collapse" id="navbarNavDropdown" >
                        ...
                        <div className="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                            <ul className="navbar-nav mb-2 mb-lg-0 gap-3 fw-medium" style={{ position: "absolute", left: "36%" }}>
                                ...
                                <li className="nav-item fs-4">
                                    <Link className={`nav-link ${location.pathname === '/community' ? 'active' : ''}`} aria-current="page" to="/community">{community}</Link>
                                </li>
                                <li className="nav-item fs-4">
                                    <Link className={`nav-link ${location.pathname === '/discussion' ? 'active' : ''}`} aria-current="page" to="/discussion">{discussion}</Link>
                                </li>
                            </ul>
                        </div>
                                            ...
                                            <div className='mx-2'>
                                                <div className="my-body">
                                                    <div className="darkThemeBtn d-flex justify-content-center">
                                                        <input id="darkmode-toggle" type="checkbox" checked={mode === 'dark'} onChange={toggleMode} />
                                ...
                                <>
                                    <ul className="navbar-nav">
                                        <div className="Navbar-Btn-Group">
                                            ...
                                            <li className="nav-item dropdown mx-2" style={{ background: mode === 'dark' ? 'black' : 'white', color: mode === 'dark' ? 'white' : 'black' }}>
                                                <a className="nav-link profile-img" href="#" id="navbarScrollingDropdown" role="button"
                                                    data-bs-toggle="dropdown" aria-expanded="false" >
                                                    {image ? (
                                                        <img src={image} style={{ width: "3.2rem", height: "3.2rem", outline: mode === 'dark' ? '1.8px solid white' : '' }} alt="avatar" />
                                                    ) : (
                                                        <img
                                                            src={avatarDropdown}
                                                ...
                                                <ul className="dropdown-menu" aria-labelledby="navbarScrollingDropdown" style={{ backgroundColor: mode === 'dark' ? 'black' : 'white', borderBottom: mode === 'dark' ? '1px solid white' : '1px solid black', outline: mode === 'dark' ? '2px solid white' : '2px solid black' }}>
                                                    <li><Link to="/myprofile">My Profile</Link></li>
                                                    <li><Link to="/editprofile">Edit Profile</Link></li>
                                                    <li>
                                                        <hr className ="dropdown-divider" style={{ backgroundColor: mode === 'dark' ? 'black' : 'white', borderBottom: mode === 'dark' ? '1px solid white' : '1px solid black', outline: mode === 'dark' ? '2px solid black' : '2px solid white' }} />
                                                    </li>
