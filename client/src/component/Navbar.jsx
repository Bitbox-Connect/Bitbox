...
function Navbar(props) {
    ...
    return (
        <div>
            <nav className={`navbar navbar-expand-lg ${isScrolled ? 'sticky' : ''} navbar-${props.mode} bg-${props.mode}`} id='navbar'>
                                        ...
                                        <div className="Navbar-Btn-Group">
                                            ...
                                            <div>
                                                <label className="theme-switch mx-2">
                                                    <input type="checkbox" className="theme-switch__checkbox" checked={props.mode === 'dark'} onChange={props.toggleMode} />
