                        ...
                        {!localStorage.getItem('token') ?
                            <>
                                <div className="Navbar-Btn-Group">
                                    ...
                                    <Link className='Navbar-Btn mx-2' role="button" to='/login'>Login</Link>
                                    <Link className='Navbar-Btn mx-2' role="button" to='/signup'>Signup</Link>
                                </div>
                            </>
                            :
                            <>
                                <div className="Navbar-Btn-Group">
                                    ...
                                    <button onClick={handleLogout} className='Navbar-Btn mx-2' role='button'>Logout</button>
                                </div>
                            </>
                        }
                    </form>
