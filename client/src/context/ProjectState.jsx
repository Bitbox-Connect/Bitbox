...
const ProjectStates = (props) => {
  ...
  const getGlobalProjects = async () => {
    ...
    const response = await fetch(`${VITE_SERVER_PORT}/api/projects/fetchallglobalprojects`, {
      method: "GET",
      headers: {
  ...
  const getUserProjects = async () => {
    ...
    const response = await fetch(`${VITE_SERVER_PORT}/api/projects/fetchalluserprojects`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
  ...
  const addProject = async (title, description, gitHubLink, youTubeLink) => {
    ...
    const response = await fetch(`${VITE_SERVER_PORT}/api/projects/addproject`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "auth-token": localStorage.getItem('token')
  ...
  const deleteProject = async (id) => {
    ...
    const response = await fetch(`${VITE_SERVER_PORT}/api/projects/deleteproject/${id}`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        "auth-token": localStorage.getItem('token')
  ...
  const editProject = async (id, title, description, gitHubLink, youTubeLink) => {
    ...
    const response = await fetch(`${VITE_SERVER_PORT}/api/projects/updateproject/${id}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        "auth-token": localStorage.getItem('token')
